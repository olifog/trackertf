...
// Recharts renders inside a container that reads CSS custom properties. Each
// series in a chart maps to a config entry; the config drives both the legend/
// tooltip labels and the `--color-<key>` variables the chart primitives use.
...
// Resolve a config entry from a recharts payload item, tolerating the several
// shapes recharts uses (top-level dataKey/name, or nested payload fields).
